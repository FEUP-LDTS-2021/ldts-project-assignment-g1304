...
public class AsteroidCreatorTest extends Assertions {
    ...
    void create(){
       ...
       assertEquals(50,a1.getPosition().getX());
       assertEquals(0,a1.getPosition().getY());
       assertTrue(DoubleComparables.equalDouble(-24.74873734152916,a1.getVelocity().getY()));
       assertTrue(DoubleComparables.equalDouble(-24.74873734152916,a1.getVelocity().getX()));

       assertEquals(500.0,a2.getPosition().getX());
       assertEquals(50,a2.getPosition().getY());
       assertTrue(DoubleComparables.equalDouble(-24.74873734152916,a2.getVelocity().getY()));
       assertTrue(DoubleComparables.equalDouble(-24.74873734152916,a2.getVelocity().getX()));

       assertEquals(50.0,a3.getPosition().getX());
       assertEquals(500,a3.getPosition().getY());
       assertTrue(DoubleComparables.equalDouble(-24.74873734152916,a3.getVelocity().getY()));
       assertTrue(DoubleComparables.equalDouble(-24.74873734152916,a3.getVelocity().getX()));
    }
}
