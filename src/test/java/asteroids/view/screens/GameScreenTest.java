...
/*
    ...
    void testCreateAsteroidsView(){
        ...
        Mockito.when(BMCL.model.getAsteroids()).thenReturn(asteroids);

        // when
        GameScreen gameScreen = new GameScreen(BMCL.model);
    ...
    void testGetLaserViews(){
        ...
        Mockito.when(BMCL.model.getLaserCreator().getLaserBeamList()).thenReturn(lasers);
